...
因此，若要在md文件的"在html代码块"中使用小于号，需要用转移字符"&#60;"替代！大于号为"&#62"！其他符号也注意查转义字符。注意：在.md文件自身中，如果不被blockquote这样的html代码块包围的话，使用<>是没关系的！因此，可以使用tab键，通过自动添加“pre”和“code”代码来当做code引用，也可以实现不需转换即可显示<>符号。
